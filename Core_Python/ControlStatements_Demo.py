...
# Real time Example of While conditions.
# Q: Write a program to strip the few characters from string. (strip types: lstrip, rstrip, strip)
#  lstrip : '(', rstrip:')', ' ': strip
# str : (   (Hi I am a example strip )  )) ----> "Hi I am a example strip"
